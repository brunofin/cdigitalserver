...
public class CtrCozinheiroGerenciar implements Controle {
	...
	public CtrCozinheiroGerenciar(Controle ctrParent, boolean isEditar,
	...
	private void configurar() {
		...
		form.getComboBoxEstados().setModel(
				new DefaultComboBoxModel<Estado>(Estado.values()));
		// combo estados
		// form.getComboBoxEstados().setModel(new DefaultComboBoxModel(new
		// String[] {
	...
	private void adicionarListeners() {
		...
		form.getOkButton().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (editando) {
					...
					if (alterou) {
						JOptionPane.showMessageDialog(null,
								"Cozinheiro Editado!");
						parent.setVisible(true);// chama o dao para atualizar a
												// lista
						form.dispose();
					}
					return;
				...
				JOptionPane.showMessageDialog(null, "Cozinheiro Não Inserido!",
						"Erro", JOptionPane.ERROR_MESSAGE);
			}
		});
		// botao excluir foto
	...
	private List<String> validarCampos() {
		...
		String data = form.getTxtDataNascimento().getText()
				.replaceAll("[/ ]", "");
		if (data.equals("")) {
		...
		if (cpf.equals("")) {
			// if(form.getTxtCpf().getText()==null
			// ||form.getTxtCpf().getText().equals("")){//mascara deixa tamanho
			// certo
			campos.add("CPF é obrigatório");
		}
		String rg = form.getTxtRg().getText().replaceAll("[-. ]", "");
		if (rg.equals("")) {
			// if(form.getTxtRg().getText()== null ||
			// form.getTxtRg().getText().equals("")){//mascara deixa tamanho
			// certo
			campos.add("RG é obrigatório");
		}
		if (form.getTxtTelefone().getText() == null
				|| form.getTxtTelefone().getText().equals("")) {
		...
		if (form.getTxtCelular().getText() == null
				|| form.getTxtCelular().getText().equals("")) {
		...
		if (form.getTxtAreaHistorico().getText() == null
				|| form.getTxtAreaHistorico().getText().equals("")) {
		...
		if (form.getTxtAreaEspecialidade().getText() == null
				|| form.getTxtAreaEspecialidade().getText().equals("")) {
		...
		if (form.getTxtCep().getText() == null
				|| form.getTxtCep().getText().equals("")) {
		...
		if (form.getTxtNumero().getText() == null
				|| form.getTxtNumero().getText().equals("")) {
		...
		if (form.getTxtRua().getText() == null
				|| form.getTxtRua().getText().equals("")) {
		...
		if (form.getTxtCidade().getText() == null
				|| form.getTxtCidade().getText().equals("")) {
		...
		if (form.getTxtBairro().getText() == null
				|| form.getTxtBairro().getText().equals("")) {
	...
	/**
	 * Método que preenche todos os campos da tela com os dados do cozinheiro
	 * que será editado
	 */
	private void preencherCamposTela() {
		...
		String dataNasc = formatoData.format(cozinheiro.getDataNascimento()
				.getTime());
		...
		System.out.println(cozinheiro.getEndereco().getEstado());
		form.getComboBoxEstados().setSelectedItem(
				cozinheiro.getEndereco().getEstado().name());// OK
